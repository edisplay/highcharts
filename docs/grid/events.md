...
| `beforeTreeRowToggle`  | Triggered before a TreeView row is expanded or collapsed. Call `event.preventDefault()` to cancel the toggle. | `this: Grid`          |
| `afterTreeRowToggle`   | Triggered after a TreeView row is expanded or collapsed. | `this: Grid`          |
